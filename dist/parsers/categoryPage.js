...
function scrapedMangaCategory(category_1) {
    return __awaiter(this, arguments, void 0, function* (category, page = 1) {
        var _a, _b;
        const res = {
            mangaCategory: [],
            totalEntities: '',
        ...
        try {
            ...
            // await browser.close();
            const content = yield axios_1.client.get(`/type/${category}?page=${page}`);
...
exports.default = scrapedMangaCategory;
