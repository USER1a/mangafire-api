...
function scrapeLatestPage(pageType_1) {
    return __awaiter(this, arguments, void 0, function* (pageType, page = 1) {
        var _a, _b;
        const res = {
            results: [],
            currentPage: page,
        ...
        try {
            const content = yield axios_1.client.get(`/${pageType}?page=${page}`);
...
exports.default = scrapeLatestPage;
